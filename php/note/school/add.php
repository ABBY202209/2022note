        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <input type="text" name="school_num" value="<?=$max+1?>">
                </td>
            </tr>
            <tr>
                <td>姓名</td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- <select name="classes" id="" onchange="update.php"> -->
                        <!-- onchange="update.php 失敗了 -->
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php
                        $SQL = "SELECT max(`school_num`) FROM `students`";
                        $max=$PDO->query($SQL)->fetchColumn(); //拿到值(只抓資料的第一筆)
